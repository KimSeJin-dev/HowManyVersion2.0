...
//정보를 이용해 QR코드 생성
public class InCreateQR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_create_qr);

        iv = (ImageView)findViewById(R.id.qrcodeIn);
    ...
    private void putInformation(){
        DatabaseHelper databaseHelper = new DatabaseHelper(InCreateQR.this, "DB", null, 1);
        ...
        try (Cursor cursor = db.query(tableName, null, null, null, null, null, null)) {
            if (cursor != null) {
                ...
                Toast.makeText(InCreateQR.this, "정보가 입력되지 않았습니다. 탈퇴 후 재 로그인해주세요." , Toast.LENGTH_SHORT).show();
            }
        } catch(Exception e){
            Toast.makeText(InCreateQR.this, "QR code 생성 실패." , Toast.LENGTH_SHORT).show();
